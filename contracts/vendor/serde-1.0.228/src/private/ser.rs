    ...
    S: Serializer,
{
    ...
    fn serialize_f32(self, _: u32) -> Result<Self::Ok, Self::Error> {
        Err(self.bad_type(Unsupported::Float))
    }

    fn serialize_f64(self, _: u64) -> Result<Self::Ok, Self::Error> {
        Err(self.bad_type(Unsupported::Float))
    }
...
mod content {
        ...
        E: ser::Error,
    {
        ...
        fn serialize_f32(self, _v: u32) -> Result<Content, E> {
            Err(E::custom("float not supported"))
        }

        fn serialize_f64(self, _v: u64) -> Result<Content, E> {
            Err(E::custom("float not supported"))
        }
